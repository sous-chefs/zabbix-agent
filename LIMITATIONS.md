...
| --- | --- |
| Debian | build-essential, libcurl4, libcurl4-openssl-dev, libpcre2-dev, pkg-config, tar |
| RHEL | gcc/make toolchain, curl-devel, openssl-devel, pcre2-devel, pkgconf-pkg-config, tar |
